...
import "./index.scss";
import { allLegit, allScam,calcDayPassed, formatDate, shuffleArray } from "../../../utils/helpers";
    ...
    <CustomContainer topPadding="10">
      ...
      <CustomContainer topMargin="5">
        ...
        <FlexRow wrap="wrap" gap="2" topMargin="3">
          {recent?.length === 0 && <AppText color="rgba(0,0,0,.7)">Oops!!! No recently added TV!</AppText>}
          {recent?.map((list) => (
            <CustomContainer
              width="40"
              radius="1"
